...
<div class="Top">
  ...
  <div class="Scroll">
  	<marquee scrollamount="2" onMouseOver="stop();" onMouseOut="start();">
  		In case of any technical difficulties, please contact support at 022-25555 5566
    </marquee>
  </div>
...
<div class="MainLoginBox">
  <div class="LoginTitle">Exception </div>
	Message: <br /><font color=red><%=request.getAttribute("error")%> </font><br />
	<h3>Please contact support/Administrator at 022-25555 5566</h3>
    </div>
</body>
</html>
