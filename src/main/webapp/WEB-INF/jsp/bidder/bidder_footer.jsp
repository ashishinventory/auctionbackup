...
<script type="text/javascript">
	...
	function PopupCenter(pageURL, title1,w,h) {
		...
		var options = 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=auto, resizable=yes, width='+w+', height='+h+', top='+top+', left='+left;
...
<div class="AutoBidMain">
    <div class="AutoBidMain">
      <div class="Menusdiv">
            ...
            <tr>
              <td align="left" valign="top" ><form action="" method="post" name="form1" id="form3" style="margin:0px;">
                  <table width="400" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td height="30" colspan="2" align="left" bgcolor="#9CBA5A" style="border-right:1px solid #fff;padding-left:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td width="219" height="30" bgcolor="#f0f3ea" class="td" style="border-right:1px solid #fff; padding-left:10px;">Start Time :</td>
                      <td bgcolor="#f0f3ea" class="td" style="padding-left:10px;;"><div id="starttime"><%= new java.util.Date() %></div></td>
                    </tr>
                    <tr>
                      <td width="219" height="30" bgcolor="#f0f3ea" class="td" style="border-right:1px solid #fff; padding-left:10px;">End Time :</td>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#f0f3ea" class="td" style="padding-left:10px;">1 Mins</td>
                    </tr>
                    <tr>
        ...
        <div class="MenuBtn"> <a href="#" class="detail  ui-corner-all" onclick="javascript:setBiddingDetailVal();" onMouseover="ddrivetip('Bidding Detail','', 'auto')";
onMouseout="hideddrivetip()">Bidding Detail</a></div>
       <div class="bidhistory" title="Bidding History" style="display:none;">
                          ...
                          <tr></tr>
                            ...
                            <tr>
                              ...
                              <tr style="color:#fff;">
                                  ...
                                  <tr>
                                    <td height="20" align="center" valign="middle" bgcolor="#EFEFF7" class="td">24/2.2011, 11:02:05PM</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">INR 20,000</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">Lorem Ipsum lrem</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">3</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">N</td>
                                  </tr>
                                  <tr>
                                    <td height="20" align="center" valign="middle" bgcolor="#EFEFF7" class="td">24/2.2011, 11:02:05PM</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">INR 80,000</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">Lorem Ipsum lrem</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">&nbsp;</td>
                                    <td align="center" valign="middle" bgcolor="#EFEFF7" class="td">A</td>
                                  </tr>
                              </table></td>
                            </tr>
                            <tr>
        ...
        <div class="MenuBtn"> <a href="#" onMouseover="ddrivetip('Bidding History','', 'auto')";
onMouseout="hideddrivetip()" onclick = "javascript:getBiddingHistory();"> Bidding History</a></div>
      </div>
