		...
		<form action="${form_url}" method="post" modelAttribute="reportVO"
			...
			<div class="summeryDiv">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr
						style="font: bold 14px Arial, Helvetica, sans-serif; color: #fff;">
						<td width="9%" height="29" align="center" bgcolor="#9CBA5A"><a
							href="${report_summary1_url}" class="SummeryLink"
							onmouseover="ddrivetip('Summary 1','', 'auto')"
							; onmouseout="hideddrivetip()">Summary 1</a></td>
						<%-- <td width="9%" align="center" bgcolor="#4A82BD"
							style="border-left: 1px solid #fff; border-right: 1px solid #fff;"><a
							href="${report_summary2_url}"
							onmouseover="ddrivetip('summary 2','', 'auto')"
							; onmouseout="hideddrivetip()" class="SummeryLink">Summary 2</a></td> --%>
						<td width="9%" align="center" bgcolor="#4A82BD"><a href="#"
							class="SummeryLink"
							onmouseover="ddrivetip('Coming Soon','', 'auto')"
							; onmouseout="hideddrivetip()">Bidder wise</a></td>
						<td width="50%">&nbsp;</td>
						<td width="25%"><a href="#"
							class="ui-state-default ui-corner-all"
							onclick="javascript:onSubmitExcel();">Export to Excel</a> <a
							href="#" class="ui-state-default ui-corner-all"
							onclick="javascript:onSubmitPDF();">download PDF</a> <a href="#"
			...
			<div class="CheckBoxMenu">
				<form style="margin: 0px;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="8%" height="29" align="left" valign="middle">Select
								Date From</td>
							<td width="12%" align="left" valign="middle"><input
							...
							<td width="78%" align="left" valign="middle"><input
								...
								onclick="displayCalendar(document.dateForm.dateTo,'dd/mm/yyyy',this)">
									...
									type="hidden" name="lotsStatus" value="" /> <input
			...
			<div class="DetailDiv">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="3%" height="40" align="center" valign="middle"
...
onmouseout="hideddrivetip()" class="TitleLink">Sr. No.</a></td>
						<td width="4%" align="center" valign="middle" bgcolor="#4f81bc"
...
onmouseout="hideddrivetip()" class="TitleLink">Description</a></td>
						<td width="10%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><select name="category"
							id="category" onChange="getResultForCategory(this.value)">
...
onmouseout="hideddrivetip()" class="TitleLink">Remark</a></td>
						<td width="6%" align="center" valign="middle" bgcolor="#4f81bc"
							...
							;
onmouseout="hideddrivetip()" class="TitleLink">Length
								Range</a></td>
						<td width="8%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><a href="#"
							onmouseover="ddrivetip('Actual Length (Approx)','', 'auto')"
							;
...
onmouseout="hideddrivetip()" class="TitleLink">Quantity</a></td>
						<td width="3%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><a href="#"
							onmouseover="ddrivetip('Zone','', 'auto')"
							;
onmouseout="hideddrivetip()" class="TitleLink">Zone</a></td>
						<td colspan="2" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><a href="#"
							onmouseover="ddrivetip('H1','', 'auto')"
							;
onmouseout="hideddrivetip()" class="TitleLink">H1</a></td>
						<td colspan="2" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><a href="#"
							onmouseover="ddrivetip('H2','', 'auto')"
							;
onmouseout="hideddrivetip()" class="TitleLink">H2</a></td>
						<td colspan="2" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><a href="#"
							onmouseover="ddrivetip('H3','', 'auto')"
							;
onmouseout="hideddrivetip()" class="TitleLink">H3</a></td>
						<td width="7%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><a href="#"
							onmouseover="ddrivetip('Lots Status','', 'auto')"
							;
onmouseout="hideddrivetip()" class="TitleLink">Lot's
								Status</a></td>
						<td width="5%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><a href="#"
							onmouseover="ddrivetip('Sales Price','', 'auto')"
							;
onmouseout="hideddrivetip()" class="TitleLink">Sales Price</a></td>
						<td width="5%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorLastTitle"><a href="#"
							onmouseover="ddrivetip('Total Sales (Qty X Sales Price)','', 'auto')"
							;
onmouseout="hideddrivetip()" class="TitleLink">Total Sales
								(Qty X SalesPrice)</a></td>
					</tr>

					<tr>
						<td width="3%" height="40" align="center" valign="middle"
							bgcolor="#4f81bc" class="DetailBorRightTitle">&nbsp;</td>
						<td width="4%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle">&nbsp;</td>
						<td width="6%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle">&nbsp;</td>
						<td width="10%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle">&nbsp;</td>
						...
						<td width="3%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle">&nbsp;</td>
						<td width="5%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle" style="border-top: 1px solid #fff;">Company
							Name</td>
						<td width="4%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle" style="border-top: 1px solid #fff;">Bid
							Price</td>
						<td width="5%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle" style="border-top: 1px solid #fff;">Company
							Name</td>
						...
						<td width="3%" align="center" valign="middle" bgcolor="#4f81bc"
							...
							Price</td>
						<td width="7%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle"><select name="bidsStatus"
							id="bidsStatus" onchange="getResultForLotStatus(this.value)">
								<option value="0">All</option>
						...
						<td width="5%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorRightTitle">&nbsp;</td>
						<td width="5%" align="center" valign="middle" bgcolor="#4f81bc"
							class="DetailBorLastTitle">&nbsp;</td>
					</tr>
					<c:forEach items="${BidsList}" var="bids" varStatus="status">
						<tr class="table">
							<td height="40" align="center" valign="middle"
								class="DetailBorRight">${bids.bidItem.serialNo}.</td>
													...
													<table width="700" border="0" cellspacing="0"
														...
														<tr>
															...
															<td width="131" align="center" valign="middle"
																bgcolor="#abcb67" style="border-right: 1px solid #fff;">Material
																Name</td>
															...
															<td width="87" align="center" valign="middle"
																bgcolor="#abcb67" style="border-right: 1px solid #fff;">Zone</td>
														</tr>
														<tr>
															<td width="49" height="30" align="center" valign="middle"
																bgcolor="#f7c794" style="border-right: 1px solid #fff;">${bids.bidItem.serialNo}.</td>
															<td width="92" align="center" valign="middle"
																bgcolor="#f7c794" style="border-right: 1px solid #fff;">${bids.bidItem.category.categoryName}</td>
															<c:forEach items="${bids.bidItem.itemLots}"
																var="itemLotUnique" varStatus="status2">
																<c:if test="${status2.index+1 == 1}">
																	<td align="center" valign="middle" bgcolor="#f7c794"
																		style="border-right: 1px solid #fff;">${itemLotUnique.lotNo}</td>
																</c:if>
															</c:forEach>

															<td width="131" align="center" valign="middle"
																bgcolor="#f7c794" style="border-right: 1px solid #fff;">${bids.bidItem.name}</td>
															...
															<td width="87" align="center" valign="middle"
																bgcolor="#f7c794" style="border-right: 1px solid #fff;">${bids.bidItem.totalQuantity}
															...
															<c:if test="${fn:length(bids.bidItem.itemLots) == 1}">
																<c:forEach items="${bids.bidItem.itemLots}"
																	...
																	<td width="87" align="center" valign="middle"
																		bgcolor="#f7c794"
																		style="border-right: 1px solid #fff;">${bids.bidItem.zone}</td>
																</c:forEach>
															</c:if>
															<c:if test="${fn:length(bids.bidItem.itemLots) > 1}">
																<td align="center" valign="middle" bgcolor="#f7c794"
														...
														<c:if test="${fn:length(bids.bidItem.itemLots) > 1}">
															<c:forEach items="${bids.bidItem.itemLots}" var="itemLot"
																varStatus="status1">
																<tr>
																	...
																	<td align="center" valign="middle" bgcolor="#f0f3ea"
																		style="border-right: 1px solid #fff;">${bids.bidItem.category.categoryName}</td>
																	<td align="center" valign="middle" bgcolor="#f0f3ea"
																	...
																	<td align="center" valign="middle" bgcolor="#f0f3ea"
																		...
																		${itemLot.unit}</td>
																	<td align="center" valign="middle" bgcolor="#f0f3ea"
																		style="border-right: 1px solid #fff;">${itemLot.zone}</td>
																</tr>
															</c:forEach>
														</c:if>
							...
							<td align="center" valign="middle" class="DetailBorRight"><a
								href="#" class="LinkSelected">${bids.bidItem.name}</a></td>
							<c:if test="${fn:length(bids.bidItem.itemLots) == 1}">
								<c:forEach items="${bids.bidItem.itemLots}" var="itemLotUnique"
									varStatus="status2">
							...
							<td align="center" valign="middle" class="DetailBorRight">${bids.bidItem.totalQuantity}
								${bids.bidItem.unit}</td>
							<c:if test="${fn:length(bids.bidItem.itemLots) == 1}">
								<c:forEach items="${bids.bidItem.itemLots}" var="itemLotUnique"
									varStatus="status2">
							...
							<td align="center" valign="middle" class="DetailBorRight"><c:if
									test="${not empty bids.salesPrice}">  
        		${bids.bidItem.currency} ${bids.salesPrice} 
        	</c:if></td>
							<td align="center" class="DetailBorLast"><span
								class="DetailBorLast"> <c:if
										test="${not empty bids.totalSalesPrice}"> 
        		${bids.bidItem.currency} ${bids.totalSalesPrice}
					...
					<tr>
						<td height="40" align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td height="40" align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						...
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight"><strong>Total</strong></td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">${reportsTotal.totalQuantity}
							${bids.bidItem.unit}</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">INR ${reportsTotal.totalBidAmount1}</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">INR ${reportsTotal.totalBidAmount2}</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">INR ${reportsTotal.totalBidAmount3}</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" bgcolor="#9CBA5A" class="DetailBorLast">INR
							${reportsTotal.finalTotalSalesPrice}</td>
					</tr>
					...
					<tr>
						...
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight"><strong>&nbsp;</strong></td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
						<td align="center" valign="middle" bgcolor="#9CBA5A"
							class="DetailBorRight">&nbsp;</td>
